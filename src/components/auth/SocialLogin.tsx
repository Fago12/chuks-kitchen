    ...
    return (
        <div className="social-login">
            ...
            <div className="social-login__buttons">
                <button className="social-login__btn social-login__btn--google" onClick={onGoogleLogin}>
                    <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google" />
                    Continue with Google
                </button>

                <button className="social-login__btn social-login__btn--apple" onClick={onAppleLogin}>
